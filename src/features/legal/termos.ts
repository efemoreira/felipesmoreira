...
/** O texto de /terms. Saiu da page em 12/09: conteúdo mora em features/. */
export const titulo = "Termos de Uso";
export const resumo = "As regras de convivência do site e da área da militância. Em resumo: informação verdadeira na inscrição, senha é pessoal, e material do movimento é para o movimento.";
